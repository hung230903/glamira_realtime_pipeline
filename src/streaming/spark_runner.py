...
from config.base import IP2LOCATION_DB_PATH, CHECKPOINT_PATH, KAFKA_BOOTSTRAP_SERVERS, KAFKA_TOPIC, \
    KAFKA_SASL_MECHANISM, KAFKA_SECURITY_PROTOCOL, KAFKA_SASL_JAAS_CONFIG
...
def main():
    spark = (
        ...
        .appName("RealtimeStarSchemaAnalysis")
    ...
    # Read from Kafka
    logger.info(
        f"Subscribing to Kafka: {KAFKA_BOOTSTRAP_SERVERS}, "
        f"topic: {KAFKA_TOPIC}"
    )
